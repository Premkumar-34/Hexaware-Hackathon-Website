...
//        }
        ...
        public List<Jobs> searchJobs(
            ...
            return jobService.searchJobs(jobTitle, jobLocation, employmentType);
        }

        // to get the job full details

//        @GetMapping("/job/{id}")
//        public ResponseEntity<Jobs> getJobById(@PathVariable Long id){
//            Optional<Jobs> jobs = jobService.getFullDetailsOfTheJob(id);
//            if (jobs.isPresent()){
...
//        }
        ...
        public ResponseEntity<Jobs> getJobByIdForJobTitle(@PathVariable Long jobId) {
